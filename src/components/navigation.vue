  ...
  <div class="content-navigation-wrapper">
    <div class="action-bar">
      <div class="action-button">
        <v-button small to="/flow-manager"> Home </v-button>
        <v-button small @click="onNavigationAction">
    ...
    <v-list v-model="activeGroups" scope="content-navigation" class="content-navigation" tabindex="-1" nav :mandatory="false">
      <navigation-item
        v-for="(flow, flowIndex) in filteredRootFlows"
...
const filteredRootFlows = ref(rootFlows.value);
